...
def main():
    ...
    image_PATH = '/home/johnlee832/Documents/ECE324-data/clean_dataset/train_data/'
    split_data('./data/output.csv',0.2)
    trainloader, validloader = getLoaders(image_PATH,'./data/train.csv','./data/validation.csv',224,1,0)
