# v2: concatenate source, target images at beginning of left UNet
...
class UNet(torch.nn.Module):
    ...
    def __init__(self, in_c = 6, out_c = 3, outer_nc=64, inner_nc=512, dropout=False):
        """[summary]
        ...
        self.module6r = sub_right(inner_nc, inner_nc, kernel_size = 3, relu=self.relu, norm=nn.BatchNorm2d(inner_nc), tanh=None, dropout=dropout)
...
def define_T(in_c = 6, out_c = 3, outer_nc=64, inner_nc=512, dropout=False, gpu_ids=[0], init_type='normal'):
